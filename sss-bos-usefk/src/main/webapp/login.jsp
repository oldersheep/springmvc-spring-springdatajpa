...
<script type="text/javascript">
	...
	$(function(){
		$("#loginBtn").click(function(){
			if($("#idInput").val()=="" || $("#pwdInput").val()==""){
				$.messager.alert("提示信息", "用户名或者密码不能为空！！", "warning");
			} else if(document.getElementById('loginform:codeInput').value==""){
...
<body>
	<div
		...
		<img src="images/logo.png" style="border-width: 0; margin-left: 0;" />
		<span style="float: right; margin-top: 35px; color: #488ED5;">新BOS系统以XXX开发的ERP系统为基础，致力于便捷、安全、稳定等方面的客户体验</span>
	</div>
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform">
					<div id="idInputLine" class="loginFormIpt showPlaceholder" style="margin-top: 5px;">
						<input id="idInput" type="text" name="username" class="loginFormTdIpt" maxlength="50" />
						<label for="idInput" class="placeholder" id="idPlaceholder">帐号：</label>
					</div>
					<div class="forgetPwdLine"></div>
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<input id="pwdInput" class="loginFormTdIpt" type="password" name="password" value="" />
					...
					<div class="loginFormIpt loginFormIptWiotTh" style="margin-top:58px;">
						...
						<a id="loginform:j_id19" name="loginform:j_id19">
							<span id="loginBtn" class="btn btn-login" style="margin-top:-36px;">登录</span>
						</a>
					</div>
					<div>
						<font color="red">
	...
	<div style="width: 900px; height: 50px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -450px;; margin-top: 220px;">
		<span style="color: #488ED5;">Powered By www.xxx.com</span>
		...
		<span style="float: right; color: #488ED5;">BOS系统</span>
	</div>
</body>
</html>