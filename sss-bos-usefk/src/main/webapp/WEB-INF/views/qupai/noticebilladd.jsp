...
<script type="text/javascript">
	$(function(){
		...
		$("input[name=telephone]").blur(function(){
			...
			//发送ajax请求，提交手机号
			var url = "noticebill/findCustomerByTelephone";
		...
		$('#save').click(function(){
			...
			if($('#noticebillForm').form('validate')){
				console.log($('#noticebillForm').serialize());
...
<body class="easyui-layout" style="visibility:hidden;">
	<div region="north" style="height:31px;overflow:hidden;" split="false" border="false">
		<div class="datagrid-toolbar">
			<a id="save" icon="icon-save" class="easyui-linkbutton" plain="true">新单</a>
			<a id="edit" icon="icon-edit" href="page/qupai_noticebill" class="easyui-linkbutton" plain="true">工单操作</a>	
		</div>
	</div>
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="noticebill/add" method="post" enctype="multipart/form-data">
			<table class="table-edit" width="100%" align="center">
				...
				<tr>
					<td>取件地址</td>
					<td colspan="3">
					<input required="true" type="text" class="easyui-validatebox" name="pickaddress" size="144"/>
					</td>
				</tr>
				<tr>
					<td>到达城市:</td>
